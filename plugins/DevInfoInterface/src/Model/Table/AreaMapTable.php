...
use App\Model\Entity\AreaMap;
use Cake\ORM\Table;

/**
 * Area Map
 */
class AreaMapTable extends Table {
    ...
    public function initialize(array $config) {
        $this->table('UT_Area_Map');
        $this->primaryKey(_AREAMAP_AREA_MAP_NID);
    ...
    public function insertData($fieldsArray = []) {
        ...
        if ($result) {
            return $result->{_AREAMAP_AREA_MAP_NID};
        } else {
            return 0;
        }
    }
